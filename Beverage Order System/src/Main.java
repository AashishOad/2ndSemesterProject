...
public class Main extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(btnOrder)) {
			...
			int result = JOptionPane.showConfirmDialog(this, report+"\nTotal :"+total,"Confirm Order",JOptionPane.OK_CANCEL_OPTION);
			...
			if (result == JOptionPane.YES_OPTION) {
				...
				btnOrder.setEnabled(false);
				list_of_bvr.clear();
				Cart cart=new Cart(report,total);
				cart.start();
				JOptionPane.showMessageDialog(this,	 "Thanks for Shopping with us!  Your Receipt Has been Generated");
